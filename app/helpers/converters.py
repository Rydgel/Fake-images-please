...
class ColorConverter(BaseConverter):
    """This converter is used to be sure that the color setted in the URL is a valid hexadecimal one."""
...
class ImgSizeConverter(IntegerConverter):
    """This converter is used to be sure that the requested image size is not too big"""
    def __init__(self, url_map):
